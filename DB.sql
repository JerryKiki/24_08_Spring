...
ALTER TABLE article ADD COLUMN author INT(10) UNSIGNED NOT NULL AFTER updateDate;
...
ALTER TABLE article ADD COLUMN boardId INT(10) UNSIGNED NOT NULL AFTER `author`;
